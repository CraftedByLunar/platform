...
export default function InfiniteDraggableGrid({ images = [], tileSize = 200, gap = 20 }) {
    ...
    useEffect(() => {
        ...
        function animate() {
            ...
            for (const tile of tiles) {
                ...
                tile.currentOffsetX = lerp(tile.currentOffsetX, tile.targetOffsetX, 0.1);
                tile.currentOffsetY = lerp(tile.currentOffsetY, tile.targetOffsetY, 0.1);
        ...
        function updateTiles() {
            ...
            for (const tile of tiles) {
                ...
                // Handle wrapping
                if (posX > containerWidth + marginBuffer) tile.extraX -= cols * fullSize;
                if (posX + tileSize < -marginBuffer) tile.extraX += cols * fullSize;
                if (posY > containerHeight + marginBuffer) tile.extraY -= rows * fullSize;
