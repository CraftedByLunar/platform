...
const EasterEgg = () => {
  ...
  const handleClickOutside = (e) => {
    if (easterEggRef.current && !easterEggRef.current.contains(e.target)) {
      closeSearchModal();
    }
  };

  useEffect(() => {
    CustomEase.create("smoothEase", ".77, 0, .175, 1");
  ...
  return (
    <>
      <div className="main-easter-egg" ref={easterEggRef}>
        <div className="close-btn" onClick={closeSearchModal}>
          <svg
    ...
    (e) => {
      const actions = {
        ...
        Enter: () => {
          ...
          const targetPath =
            selectedItem?.path ||
            (filteredResults.length > 0 ? filteredResults[0].path : null);
    ...
    if (filteredResults.length === 0) {
      return (
        <div className="not-found-search">
          ...
          <p>
            But you can change that, <Link to="/github">contribute now!</Link>
          </p>
        </div>
      );
    }
    ...
    <>
      ...
      <div className="main-search-box" ref={searchOverlayRef}>
        <div className="search-box" ref={searchBoxRef}>
          ...
          <div className="results-search">{renderSearchResults()}</div>
        </div>
      </div>
      ...
      <div className="main-sidebar">
        <div className="logoTop">
          ...
          <div className="nav-items">
            ...
            <div className="star-github">
              <button
                onClick={() => navigate("/redirect/github")}
                id="buttonStar"
              >
        ...
        <div className="main">
          <div className="sections">
            {navItems.map((section, index) => (
              <div
                className={`category ${section.className || "category"}`}
                key={index}
              >
        ...
        <div className="userDetails">
          ...
          <div className="popupSideDetails" ref={popupRef}>
            ...
            <div className="items-popup disabled">{renderPopupItems()}</div>
          </div>
        </div>
      </div>
    </>
